...
static
    ...
    char *colors[][2] = {
        /*               fg         bg       */
        [SchemeNorm] = {"#bbbbbb", "#1e222a"},
        [SchemeSel] = {"#efefef", "#4d78cc"},
        [SchemeOut] = {"#000000", "#7594d1"},
#if BORDER_PATCH
        [SchemeBorder] = {"#000000", "#4d78cc"},
#endif // BORDER_PATCH
#if MORECOLOR_PATCH
        [SchemeMid] = {"#eeeeee", "#770000"},
#endif // MORECOLOR_PATCH
#if HIGHLIGHT_PATCH || FUZZYHIGHLIGHT_PATCH
        [SchemeSelHighlight] = {"#bc7ad9", "#383d47"},
        [SchemeNormHighlight] = {"#bc7ad9", "#1e222a"},
#endif // HIGHLIGHT_PATCH | FUZZYHIGHLIGHT_PATCH
#if HIGHPRIORITY_PATCH
